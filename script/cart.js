const products = [
  ...
  {
    name: "Hot Dog Shawarma",
    image: "hot dog shawarma.jpg",
    price: 4.99,
    qtty: 1,
  },
  {
    name: "Beef Sendwich",
    image: "Beef Sendwich.jpg",
    price: 4.99,
    qtty: 1,
  },
  {
...
for (let product of products) {
  ...
  <div class="card product col my-4" style="width: 300px;">
                ...
                <div class="card-body px-3 py-0">
                    ...
                    <p class="card-text">Here you can find the most tasty and cheapest fast food in Town.</p>
